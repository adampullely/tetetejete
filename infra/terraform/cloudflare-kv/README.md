...
| `orgName` | string | `tetetejete` | Org identifier |
| `owner` | string | `tetetejete` | GitHub owner |
| `repo` | string | `tetetejete` | GitHub repo |
| `namespace` | string | `tetetejete` | Logical namespace |
