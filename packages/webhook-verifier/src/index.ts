 ...
 * signature verifier for tetetejete outbound webhook deliveries.
 *
...
/**
 * Compute the canonical tetetejete webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a tetetejete webhook delivery.
 *
