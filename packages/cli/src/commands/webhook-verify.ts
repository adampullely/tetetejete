// `tetetejete webhook verify` — local cryptographic verification of a
// tetetejete outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `tetetejete login`.
