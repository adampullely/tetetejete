...
//   - `~/.config/tetetejete/credentials.json` (0600)
//   - `~/.config/tetetejete/config.json`     (0644)
//
// Override via `TETETEJETE_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/tetetejete` everywhere
