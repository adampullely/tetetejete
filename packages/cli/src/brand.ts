...
// `@saas/sdk` client class name (`tetetejete`) is intentionally NOT part of
...
export const CLI_BIN = "tetetejete";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "tetetejete";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.tetetejete.com";
