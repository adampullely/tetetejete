...
//   - tetetejeteError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): tetetejete {
  return new tetetejete({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the tetetejete class", () => {
