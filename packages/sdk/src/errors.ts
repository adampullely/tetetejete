// Typed error hierarchy for the tetetejete SDK.
//
...
// codes (forward compatibility) fall back to the generic `tetetejeteError`
...
export interface tetetejeteErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof tetetejeteError`
 * still matches.
 */
export class tetetejeteError extends Error {
  ...
  constructor(init: tetetejeteErrorInit) {
    super(init.envelope.message);
    this.name = "tetetejeteError";
...
export class BadRequestError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export class UnauthenticatedError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export class ForbiddenError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export class NotFoundError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export class ConflictError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export class ValidationError extends tetetejeteError {
...
export class PreconditionFailedError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export class UnsupportedError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export class InternalError extends tetetejeteError {
  constructor(init: tetetejeteErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends tetetejeteErrorInit {
...
export class RateLimitError extends tetetejeteError {
...
/**
 * Decode an HTTP `Response` into the appropriate `tetetejeteError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `tetetejeteError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new tetetejeteError(init);
  }
}

function decodeRateLimit(
  init: tetetejeteErrorInit,
  response: Response,
): RateLimitError {
